class BigStoryComponent {
    ...
    render() {
        ...
        $('#like-button-story-' + this.idValue).click({param1: this.idValue}, this.onLikeCallbackFunc)
        $('#dislike-button-story-' + this.idValue).click({param1: this.idValue}, this.onDislikeCallbackFunc)
    }
